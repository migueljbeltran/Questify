    ...
    <main className="min-h-screen bg-slate-950 text-slate-50">
      <div className="relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute right-0 top-24 h-72 w-72 rounded-full bg-emerald-500/15 blur-3xl" />
        ...
        <section className="relative">
          <div className="mx-auto grid max-w-6xl gap-10 px-4 pb-16 pt-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:pt-16">
          ...
          <div className="mx-auto grid max-w-6xl gap-6 px-4 py-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="relative">
              ...
              <div className="relative space-y-3 rounded-[26px] border border-slate-900 bg-slate-950/80 p-4 shadow-xl shadow-slate-950/50">
                ...
                <div className="space-y-2">
                  {[
                    { name: "Aurora theme", status: "Equipped" },
                    { name: "Navigator title", status: "Owned" },
                    { name: "Crystal sigil icon", status: "Owned" },
                  ].map((reward) => (
                    <div
                      key={reward.name}
